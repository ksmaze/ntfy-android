...
class DetailAdapter(private val activity: Activity, private val lifecycleScope: CoroutineScope, private val repository: Repository, private val onClick: (Notification) -> Unit, private val onLongClick: (Notification) -> Unit) :
    ...
    private val spannedCache = LruCache<String, Spanned>(200)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetailViewHolder {
        ...
        return DetailViewHolder(activity, lifecycleScope, repository, markwon, spannedCache, view, selected, onClick, onLongClick)
    }
    ...
    class DetailViewHolder(
        ...
        private val spannedCache: LruCache<String, Spanned>,
        itemView: View,
        ...
        fun bind(notification: Notification) {
            ...
            if (notification.isMarkdown()) {
                ...
                val cached = spannedCache.get(text)
                if (cached != null) {
                    markwon.setParsedMarkdown(messageView, cached)
                } else {
                    val spanned = markwon.toMarkdown(text)
                    spannedCache.put(text, spanned)
